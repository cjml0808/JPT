...
class Evaluator(object):
    ...
    def feature_for_tsne_embedding(self, epoch, X_sample, y_sample, n_classes, root_dir, alpha=0.5):
        X_embeddings = embedding_tsne(X_sample, None)

        embedding_2dpoints(X_sample, X_embeddings, y_sample, n_classes,
                           os.path.join(root_dir, "embedding_feat2d_train_points_%d_%.2f_prune.pdf" % (epoch, alpha)))
