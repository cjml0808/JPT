...
class MobileNet(nn.Module):
    __factory = {
        2: torchvision.models.mobilenet_v2,
    }
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        # Construct base (pretrained) mobilenetv2
        if depth not in MobileNet.__factory:
            raise KeyError("Unsupported depth:", depth)
        mobilenetv2 = MobileNet.__factory[depth](pretrained=pretrained)
        ...
        if not self.cut_at_pooling:
            ...
            out_planes = mobilenetv2.last_channel
