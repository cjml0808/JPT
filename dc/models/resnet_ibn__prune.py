...
from .resnet_ibn_a_prune import resnet50_ibn_a, resnet101_ibn_a


__all__ = ['ResNetIBN', 'resnet_ibn50a', 'resnet_ibn101a', 'resnet_ibn50a_ori_prune', 'resnet_ibn50a_bn_prune',
           'resnet_ibn50a_4wa_prune', 'resnet_ibn50a_4h']


class ResNetIBN_ori_prune(nn.Module):
    __factory = {
        '50a': resnet50_ibn_a,
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        super(ResNetIBN_ori_prune, self).__init__()

        self.depth = depth
        self.pretrained = pretrained
        self.cut_at_pooling = cut_at_pooling

        self.resnet = ResNetIBN_ori_prune.__factory[depth](pretrained=pretrained)
...
class ResNetIBN_bn_prune(nn.Module):
    __factory = {
        '50a': resnet50_ibn_a,
        '101a': resnet101_ibn_a
    }
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        print('pooling_type: {}'.format(pooling_type))
        super(ResNetIBN_bn_prune, self).__init__()

        self.depth = depth
        self.pretrained = pretrained
        self.cut_at_pooling = cut_at_pooling

        self.resnet = ResNetIBN_bn_prune.__factory[depth](pretrained=pretrained)
        self.resnet.layer4[0].conv2.stride = (1, 1)
        self.resnet.layer4[0].downsample[0].stride = (1, 1)
...
class ResNetIBN_4wa_prune(nn.Module):
    __factory = {
        '50a': resnet50_ibn_a,
        '101a': resnet101_ibn_a
    }
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        print('pooling_type: {}'.format(pooling_type))
        super(ResNetIBN_4wa_prune, self).__init__()

        self.depth = depth
        self.pretrained = pretrained
        self.cut_at_pooling = cut_at_pooling

        self.resnet = ResNetIBN_4wa_prune.__factory[depth](pretrained=pretrained)
        self.resnet.layer4[0].conv2.stride = (1, 1)
        self.resnet.layer4[0].downsample[0].stride = (1, 1)

        self.base_1 = nn.Sequential(
            self.resnet.conv1, self.resnet.bn1, self.resnet.relu, self.resnet.maxpool, self.resnet.layer1)
        self.base_2 = self.resnet.layer2
        self.base_3 = self.resnet.layer3
        self.base_4 = self.resnet.layer4
        # self.base = nn.Sequential(
        #     resnet.conv1, resnet.bn1, resnet.relu, resnet.maxpool,
        #     resnet.layer1, resnet.layer2, resnet.layer3, resnet.layer4)
        ...
        if not self.cut_at_pooling:
            ...
            out_planes_1 = self.resnet.layer1[2].conv3.out_channels
            out_planes_2 = self.resnet.layer2[3].conv3.out_channels
            out_planes_3 = self.resnet.layer3[5].conv3.out_channels
            out_planes_4 = self.resnet.fc.in_features
...
def resnet_ibn50a_ori_prune(**kwargs):
    return ResNetIBN_ori_prune('50a', **kwargs)

def resnet_ibn50a(**kwargs):
    return ResNetIBN('50a', **kwargs)

def resnet_ibn50a_bn_prune(**kwargs):
    return ResNetIBN_bn_prune('50a', **kwargs)

def resnet_ibn50a_4h(**kwargs):
    return ResNetIBN_4h('50a', **kwargs)

def resnet_ibn50a_4wa_prune(**kwargs):
    return ResNetIBN_4wa_prune('50a', **kwargs)
