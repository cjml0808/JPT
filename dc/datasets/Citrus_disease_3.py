...
class Citrus_disease_3(BaseImageDataset):
    dataset_dir = 'citrus_disease_3'

    def __init__(self, root, verbose=True, **kwargs):
        super(Citrus_disease_3, self).__init__()
        self.dataset_dir = osp.join(root, self.dataset_dir)
        train, test = self._process_dir(self.dataset_dir)
        if verbose:
            print("=> Citrus_disease_3 loaded")
