...
class CitrusDisease7_preprocess():
    def __init__(self, path=None):
        ...
        self.path = path
        self.label_names = ['anthracnose', 'blackspot', 'canker', 'huanglong', 'melanose', 'normal', 'sunscald']
...
class CitrusDisease7(VisionDataset):
...
class CitrusDisease4(VisionDataset):
    """`CIFAR10 <https://www.cs.toronto.edu/~kriz/cifar.html>`_ Dataset.
...
class CitrusDisease3(VisionDataset):
    """`CIFAR10 <https://www.cs.toronto.edu/~kriz/cifar.html>`_ Dataset.
...
class _CitrusDisease4(VisionDataset):   # cluster fine-tune使用，使用的数据集的标签为0， 2， 4， 6
    """`CIFAR10 <https://www.cs.toronto.edu/~kriz/cifar.html>`_ Dataset.
...
class _CitrusDisease3(VisionDataset):     # cluster fine-tune使用，使用的数据集的标签为1， 3， 5
    """`CIFAR10 <https://www.cs.toronto.edu/~kriz/cifar.html>`_ Dataset.
...
if __name__ == "__main__":
    P = CitrusDisease7_preprocess(path=os.getcwd() + '/data/citrusdisease7/citrus_disease_7/')
    # P.image_rename()
    # P.add_image()
    # P.train_test_split()
