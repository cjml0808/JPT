...
# HealthyPlant8数据集处理
class TomatoDisease5_preprocess():
    def __init__(self, path=None):
        self.raw_path = os.getcwd() + '/datasets/tomatodisease5_raw/'
        self.path = path
        self.label_names = ['lateblight', 'septorialeafspot', 'spidermitas', 'earlyblight', 'targetspot']
        # self.label_names = ['apple', 'bellpepper', 'blueberry', 'cherry', 'soybean']
        # self.label_names = ['potato', 'raspberry', 'strawberry']
        self.class_num = 5
...
class TomatoDisease5(VisionDataset):
...
if __name__ == "__main__":
    P = TomatoDisease5_preprocess(path=os.getcwd() + '/datasets/tomatodisease5/')
    # P.image_rename()
    # P.add_image()
    # P.train_test_split()
