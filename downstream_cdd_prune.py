...
def eval(mode='full_finetune'):
    ...
    PATH = f"E:/Code/densityclustering-master/Second_work/densityclustering-master/examples/logs/" \
           f"cdd_resnet_ibn50a/cdd_4head_512(4wa)_0.5_prune(0.5)_2"
    if checkpoint_exist:
        checkpoint = torch.load(os.path.join(PATH, 'model_1_0.5_prune.pth.tar'), map_location=device)
